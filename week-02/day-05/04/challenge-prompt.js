...
var set = animal.replace(animal[2],"z");
console.log(set);
...
var string1 = "";
function doubleLength(string1)
{
    string1 = string1.length * 2;
    return string1;
}
// call the `doubleLength` function with a value of "allen" and console log 
// the return value
doubleLength("allen")
console.log(doubleLength(string1));
