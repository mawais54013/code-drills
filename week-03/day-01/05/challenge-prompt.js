...
function iterateArrObjects(arrOfObj){
  // ---------- Your Code Here ----------
arrOfObj = toyArrayOfObjects[0];
console.log(arrOfObj);
arrOfObj = toyArrayOfObjects[1];
console.log(arrOfObj);
arrOfObj = toyArrayOfObjects[2];
console.log(arrOfObj);
arrOfObj = toyArrayOfObjects[3];
console.log(arrOfObj);
  // ---------- End of Code Area ----------
}
...
function iterateArrObjectsReverse(arrOfObj){
  ...
  arrOfObj = toyArrayOfObjects[19];
  console.log(arrOfObj);
  arrOfObj = toyArrayOfObjects[18];
  console.log(arrOfObj);
  arrOfObj = toyArrayOfObjects[17];
  console.log(arrOfObj);
  arrOfObj = toyArrayOfObjects[16];
  console.log(arrOfObj);
